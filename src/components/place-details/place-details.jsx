        ...
        <section className="property">
          <div className="property__gallery-container container">
            <div className="property__gallery">
              {images.map((src) => <div key={src} className="property__image-wrapper">
          ...
          <div className="property__container container">
            <div className="property__wrapper">
              ...
              <ul className="property__features">
                <li className="property__feature property__feature--entire">{Type[type]}</li>
              ...
              <div className="property__inside">
                ...
                <ul className="property__inside-list">
                  {goods.map((it) => <li key={it} className="property__inside-item">{it}</li>)}
                </ul>
              </div>
              <div className="property__host">
                ...
                <div className="property__host-user user">
                  <div className="property__avatar-wrapper property__avatar-wrapper--pro user__avatar-wrapper">
                    <img className="property__avatar user__avatar" src={host.avatarSrc} width="74" height="74" alt="Host avatar" />
                  </div>
